...
async fn process_message(
    ...
    match event_type {
        ...
        "component_render" => {
            let mut event: ComponentRenderEvent = serde_json::from_value(value)?;
            ...
            app.emit("mako:component_render", &event)?;
        }
        "component_tree" => {
            let mut event: ComponentTreeEvent = serde_json::from_value(value)?;
