///
/// NitroSalvetron-Swift-Cxx-Bridge.hpp
...
namespace margelo::nitro::salvetron::bridge::swift {
  ...
  /**
   * Specialized version of `std::shared_ptr<HybridNitroSalvetronSpec>`.
   */
  using std__shared_ptr_HybridNitroSalvetronSpec_ = std::shared_ptr<HybridNitroSalvetronSpec>;
  ...
  // pragma MARK: std::weak_ptr<HybridNitroSalvetronSpec>
  using std__weak_ptr_HybridNitroSalvetronSpec_ = std::weak_ptr<HybridNitroSalvetronSpec>;
  inline std__weak_ptr_HybridNitroSalvetronSpec_ weakify_std__shared_ptr_HybridNitroSalvetronSpec_(const std::shared_ptr<HybridNitroSalvetronSpec>& strong) noexcept { return strong; }
