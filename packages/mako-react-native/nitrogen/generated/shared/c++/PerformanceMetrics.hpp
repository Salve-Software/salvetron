...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::mako::PerformanceMetrics> final {
    static inline margelo::nitro::mako::PerformanceMetrics fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::mako::PerformanceMetrics(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::mako::PerformanceMetrics& arg) {
