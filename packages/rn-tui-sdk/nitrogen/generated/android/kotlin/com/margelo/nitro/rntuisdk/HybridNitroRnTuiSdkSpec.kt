...
/**
 * A Kotlin class representing the NitroRnTuiSdk HybridObject.
 * Implement this abstract class to create Kotlin-based instances of NitroRnTuiSdk.
 */
@DoNotStrip
@Keep
@Suppress(
...
abstract class HybridNitroRnTuiSdkSpec: HybridObject() {
  // Properties
  ...
  @DoNotStrip
  @Keep
  protected open class CxxPart(javaPart: HybridNitroRnTuiSdkSpec): HybridObject.CxxPart(javaPart) {
    // C++ JHybridNitroRnTuiSdkSpec::CxxPart::initHybrid(...)
  ...
  companion object {
    protected const val TAG = "HybridNitroRnTuiSdkSpec"
  }
}
