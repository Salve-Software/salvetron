...
import {
  useNativeLogsFilters,
  useSetNativeSearchQuery,
  useSetNativeLevelFilter,
  useClearNativeLogs,
...
export function NativeLogsFilters() {
  const filters = useNativeLogsFilters();
  const setSearchQuery = useSetNativeSearchQuery();
  const setLevelFilter = useSetNativeLevelFilter();
  const clearLogs = useClearNativeLogs();
